...
import pl.edu.wat.wcy.isi.tim.filharmoniaapp.activities.SelectSeatActivity;
import pl.edu.wat.wcy.isi.tim.filharmoniaapp.dtos.AndroidSeatDto;
import pl.edu.wat.wcy.isi.tim.filharmoniaapp.dtos.Mapper;
import pl.edu.wat.wcy.isi.tim.filharmoniaapp.dtos.SeatDto;
...
public class SelectSeatController {
    ...
    public SelectSeatController(SelectSeatActivity activity, int concertId) {
        ...
        stompClient.send(new StompMessage(StompCommand.SEND,
                Collections.singletonList(new StompHeader(StompHeader.DESTINATION, RequestSingleton.registerAdress)),
    ...
    public void SendSeatMessage(boolean isChecked, Seat seat) {
        ...
        stompClient.send(new StompMessage(StompCommand.SEND,
                Collections.singletonList(new StompHeader(StompHeader.DESTINATION, RequestSingleton.sendAdress)),
                new Gson().toJson(androidSeatDto))).subscribe();
    }
